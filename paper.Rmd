...
table_descriptives<-readRDS("table_descriptives.RDS")
...
```{r, echo=FALSE, cache=FALSE}
superhost_descriptives<-readRDS("superhost_descriptives.RDS")
knitr::kable(superhost_descriptives)
room_type_descriptives<-readRDS("room_type_descriptives.RDS")
knitr::kable(room_type_descriptives)
city_size_descriptives<-readRDS("city_size_descriptives.RDS")
