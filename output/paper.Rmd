...
A Big city has more than 1000000 (a million) residents --> Barcelona and Madrid

A Medium city has more than 500000 residents --> Sevilla, Valencia and Malaga

A Small city has less than 500000 residents --> Menorca and Girona
...
```
readRDS(superhost_descriptives)
readRDS(room_type_descriptives)
readRDS(city_size_descriptives)
```
